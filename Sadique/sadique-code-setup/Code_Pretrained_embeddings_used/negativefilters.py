        ...
        with tf.Session() as sess:
            ...
            def pruned_weights(variable_name):
                ...
                for i in range(num_filters):
                    ...
                    random_val = randint(0, 127)

                    var[:,:,:,random_val] = (var[:,:,:,random_val].clip(min = 0))
            ...
            for i,variable_name in enumerate(variables_graph_nodes):
                ...
                change_shape_op = tf.assign(new_node, pruned_filter_weights, validate_shape=False)
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "negative_filters_r1", "checkpoints"))
...
def make_graph(x_train, y_train, vocab_processor, vocab_size, embedding, x_dev, y_dev):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./negative_filters_r1/checkpoints/'))
       # print([n.name for n in tf.get_default_graph().as_graph_def().node])
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "negative_filters", timestamp))
        print("Writing to {}\n".format(out_dir))
...
if __name__ == '__main__':
    ...
    if args.prune:
        filters = prune_filter_weight("./runs/1557097931/checkpoints/model-1700.meta", './runs/1557097931/checkpoints',128)
        #filters = prune_filter_weight("./pruned_by_variance/1557090149/checkpoints/model-2600.meta", './pruned_by_variance/1557090149/checkpoints',90)
        print(filters)
