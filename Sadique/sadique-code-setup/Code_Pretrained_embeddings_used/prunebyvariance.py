...
def prune_filter_weight(meta_graph, latest_checkpoint, num_filters):
    ...
    with graph.as_default():
        ...
        with tf.Session() as sess:
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "pruned_data_by_variance_filters_tobacco_round_1", "checkpoints"))
...
def make_graph(x_train, y_train, vocab_processor, vocab_size, embedding, x_dev, y_dev):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./pruned_data_by_variance_filters_tobacco_round_1/checkpoints/'))
...
if __name__ == '__main__':
    ...
    if args.prune:
        ...
        #filters = prune_filter_weight("./pruned_by_variance/1557098859/checkpoints/model-1000.meta", './pruned_by_variance/1557098859/checkpoints',90)
        print(filters)
