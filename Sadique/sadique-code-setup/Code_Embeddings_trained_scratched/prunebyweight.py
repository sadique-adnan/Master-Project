...
def prune_filter_weight(meta_graph, latest_checkpoint, num_filters):
    ...
    with graph.as_default():
        ...
        with tf.Session() as sess:
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "pruned_by_weight_tobacco_full_round_1", "checkpoints"))
...
def make_graph(x_train, y_train, vocab_processor, x_dev, y_dev):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./pruned_by_weight_tobacco_full_round_1/checkpoints'))
       # print([n.name for n in tf.get_default_graph().as_graph_def().node])
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "prune_by_weight", timestamp))
        print("Writing to {}\n".format(out_dir))
...
if __name__ == '__main__':
    ...
    if args.prune:
        ...
        #filters = prune_filter_weight("./prune_by_weight/1557075507/checkpoints/model-1000.meta", './prune_by_weight/1557075507/checkpoints/',90)
        print(filters)
