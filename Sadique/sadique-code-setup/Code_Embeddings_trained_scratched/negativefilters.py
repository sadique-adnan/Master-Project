...
def prune_filter_weight(meta_graph, latest_checkpoint, num_filters):
    ...
    with graph.as_default():
        ...
        with tf.Session() as sess:
            ...
            out_dir = os.path.abspath(os.path.join(os.path.curdir, "negative_filters_tobacco", "checkpoints"))
...
def make_graph(x_train, y_train, vocab_processor, x_dev, y_dev):
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, tf.train.latest_checkpoint('./negative_filters_tobacco/checkpoints/'))
       # print([n.name for n in tf.get_default_graph().as_graph_def().node])
        ...
        out_dir = os.path.abspath(os.path.join(os.path.curdir, "negative_filters_tobacco", timestamp))
        print("Writing to {}\n".format(out_dir))
...
if __name__ == '__main__':
    ...
    if args.prune:
        prune_filter_weight("./runs/1557076524/checkpoints/model-21300.meta", './runs/1557076524/checkpoints/',128)
