    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            def train_step(x_batch, y_batch):
                ...
                #print('h_pool',h_pool_flat.shape)
                #print('embedded_chars', embedded_chars_expanded.shape)
            ...
            def dev_step(x_batch, y_batch, writer=None):
                ...
                np.savetxt(open("embedded_chars.txt", "w+"), predictions, fmt='%f')
                #np.savetxt(open("valid_labels_train.csv", "w+"), np.argmax(y_batch, 1), fmt='%f')
            ...
            for batch in batches:
                ...
                if current_step % FLAGS.checkpoint_every == 0:
                    ...
                    filter_val  = gr.get_tensor_by_name('conv-maxpool-3/W:0').eval()
                    #print(filter_val)
